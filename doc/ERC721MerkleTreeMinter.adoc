...
As you need to give the Merkle Tree proofs and nonces, you usually need to store them somewhere
after computing the Merkle Tree, so that your frontend can retrieve them from the connected user
on your dApp.
